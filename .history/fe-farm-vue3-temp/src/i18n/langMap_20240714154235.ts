...
export const langMap = new Map([
  ...
  {"cnName": "中文(粤语、简体)", "yue-CN", "description": "Chinese (Cantonese, Simplified)",},
  
  {"cnName": "中文(普通话、简体)", "zh-CN", "description": "Chinese (Mandarin, Simplified)"},
  {"cnName": "中文(简体吉鲁普通话)", "zh-CN-shandong", "description": "Chinese (Jilu Mandarin, Simplified)",},
  {"cnName": "中文(西南普通话，简体)", "zh-CN-sichuan", "description": "Chinese (Southwestern Mandarin, Simplified)",},
  {"cnName": "中文(粤语、繁体)", "zh-HK", "description": "Chinese (Cantonese, Traditional)"},
  {"cnName": "中文(台湾普通话，繁体)", "zh-TW", "description": "Chinese (Taiwanese Mandarin, Traditional)"},
  {"cnName": "祖鲁语(南非)", "zu-ZA", "description": "Zulu (South Africa)",}
